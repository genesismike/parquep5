...
var APPS_SCRIPT_URL = "https://script.google.com/macros/s/AKfycbyyM-WLYFXZTqlU7ftjoFSBfCh6KJJkH519rIUlfg5zZrDaxtewbhZzH8jXnpQwkW8U/exec";
...
function validate(step) {
  ...
  if (step === 2) {
    ...
    var horaEnt = document.getElementById('hora-entrada').value;
